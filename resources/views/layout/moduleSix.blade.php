                    ...
                    <table class="w3-table w3-striped w3-border" id ="AER">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="accident_records[]"></td>
                                <td><input type="text" class="form-control" name="accident_records[]"></td>
                                <td><button type="button" name="add" id="AERT" class="btn btn-outline-primary" style="float:right">+</button></td>
                            </tr>
                    ...
                    <table class="w3-table w3-striped w3-border" id ="PST">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="personel_staff[]"></td>
                                <td><button type="button" name="add" id="PersonelStaff" class="btn btn-outline-primary" style="float:right">+</button></td>
                            </tr>
