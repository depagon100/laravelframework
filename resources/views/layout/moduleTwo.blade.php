        ...
        <table class="table table-borderless table-hover" >
            <thead>  
                ...
                <tr>
                    ...
                    <h3 class="mt-3 mx-2 text-success">B. HAZARDOUS WASTE GENERATOR</h3>
            ...
            <thead>  
                ...
                <h3 class="mt-3 mx-2 text-success">HAZARDOUS WASTE GENERATION</h3>
        ...
        <table class="w3-table" >
            <tbody id="hazzardous">
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control" name="hwGeneration[]"></td>
                    ...
                    <td>
                        ...
                        <select class="form-select" name="hwGeneration[]" style="width: fit-content">
                            <option selected disabled value="">-- Select --</option>
                            <option>Toxic(T)</option>
                            <option>Corrosive(C)</option>
                            <option>Reactive(R)</option>
                            <option>Flammable(F)</option>
                            <option>T/C</option>
                            <option>T/R</option>
                            <option>T/F</option>
                            <option>C/R</option>
            ...
            <table class="table table-borderless table-hover" >
                <thead>  
                    ...
                    <tr>
                        ...
                        <h3 class="mt-3 mx-2 text-success">WASTE STORAGE, TREATMENT AND DISPOSAL (PLEASE FILL-UP ONE TABLE PER HW) </h3>
            ...
            <div class="card"  >
                <table class="table table-borderless p-3" id="hw">
                    <thead>
                        <tr>
                            <th>HW Details</th>
                        </tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="hwDetails[]"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>TSD Locations</td></tr><tr><td></td><td><input type="text" class="form-control" name="hwDetails[]"></td>
                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td><input type="text" class="form-control" name="m2transporter[]"></td>
                                <td><input type="text" class="form-control" name="m2transporter[]"></td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td><input type="text" class="form-control" name="m2transporter[]"></td>
                                <td><input type="date" class="form-control" name="m2transporter[]"></td>
                            </tr>
                        </tbody>
                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td><input type="text" class="form-control" name="treater[]"></td>
                                <td><input type="text" class="form-control" name="treater[]"></td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td><input type="text" class="form-control" name="treater[]"></td>
                                <td><input type="date" class="form-control" name="treater[]"></td>
                            </tr>
                        </tbody>
                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td><input type="text" class="form-control" name="disposal[]"></td>
                                <td><input type="text" class="form-control" name="disposal[]"></td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td><input type="text" class="form-control" name="disposal[]"></td>
                                <td><input type="date" class="form-control" name="disposal[]"></td>
                            </tr>
                        </tbody>
                ...
                <div class="card mb-3" >
                    <table class="table table-borderless" id="hw">
                            ...
                            <!-- <table class="table table-borderless" id="onsite"> -->
                                <tbody id="onsite">
                                    ...
                                    <tr>
                                        <td><input type="date" class="form-control" name="osisa[]"></td>
                                        <td><input type="text" class="form-control" name="osisa[]"></td>
                                        <td><input type="text" class="form-control" name="osisa[]"></td>
                                        <td><input type="text" class="form-control" name="osisa[]"></td>
                                        <td><button type="button" name="add" id="onSite" class="btn btn-outline-primary">+</button></td>
                                    </tr>
    ...
    <div class="container">
        <div class="col mb-3" >
            <div style="float: right" class="mb-3">
                <a href={{ url('/moduleOne') }} class="btn btn-lg border bg-light">Previous</a>
