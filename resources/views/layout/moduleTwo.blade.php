        ...
        <div class="card">
            <div class="col">
                ...
                <form action="/saveData2" post="post">
                    ...
                    <div class="container">
                        <div class="row">
                            <p class="p-1 mt-3  text-light" style="background-color:gray; font-size:20px ">
                                MODULE 2: RA 6969
                                <a href="/pdf2" class="btn btn-lg" style="float: right"><img src="images/printpdflogo.png" height="40px" width="50px" style="backgorund-color:gray;"> EXPORT PDF</a>
                            </p>
                        </div>
                    </div>
                    ...
                    <td><button type="button" name="add" id="wstd" class="btn btn-outline-primary" style="margin-left: 2.5%" >+</button></td>
