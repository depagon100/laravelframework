...
<tbody>
  ...
  <td><input type="text" name="text12[]"></td>
    ...
    <thead>
        <tr>
       <th><h2>OPERATION PRODUCTION QUALITY</h2></th>
    </tr>
       <th></th>
    </thead>
  ...
  <tbody>
    <tr>
    <td>Total Water Consumption this Quarter (cubic meters)</td>
    <th></th>
    <td><input type="text" name="text10[]"></td>
    <td>Total Electric Consumption this Quarter (kw/h)</td>
    <td><input type="text" name="text12[]"></td>
