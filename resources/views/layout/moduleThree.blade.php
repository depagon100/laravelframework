                        ...
                        <table class="table table-borderless table-hover">
                            <h3 class="mt-3 mx-2 text-success">DETAILED REPORT OF WASTEWATER CHARACTERISTICS FOR CONVENTIONAL POLLUTANTS</h3>
                                ...
                                <tbody id=drwccc>
                                    ...
                                    <tr>
                                        <td><input class="form-control" type="text" name="dreportofwaste[]"></td>
                            ...
                            <h3 class="mt-3 mx-2 text-success">DETAILED REPORT OF WASTEWATER CHARACTERISTICS FOR OTHER POLLUTANTS</h3>
                                ...
                                <tbody id=dwrcop>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td><input class="form-control" type="text"  id="opn1" name="name1"></td>
                                        <td><input class="form-control" type="text"  id="opn2" name="name2"></td>
                                        <td><input class="form-control" type="text"  id="opn3" name="name3"></td>
                                        <td><input class="form-control" type="text"  id="opn4" name="name4"></td>
                                        <td><input class="form-control" type="text"  id="opn5" name="name5"></td>
                                        <td><input class="form-control" type="text"  id="opn6" name="name6"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td><input class="form-control" type="text"  id="opu1" name="unit1"></td>
                                        <td><input class="form-control" type="text"  id="opu2" name="unit2"></td>
                                        <td><input class="form-control" type="text"  id="opu3" name="unit3"></td>
                                        <td><input class="form-control" type="text"  id="opu4" name="unit4"></td>
                                        <td><input class="form-control" type="text"  id="opu5" name="unit5"></td>
                                        <td><input class="form-control" type="text"  id="opu6" name="unit6"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><input class="form-control" type="text"   name="drowcfop1[]"></td>
                                        <td><input class="form-control" type="date"   name="drowcfop1[]"></td>
                                        <td><input class="form-control" type="text"   name="drowcfop1[]"></td>
                                        <td><input class="form-control" type="text"   name="drowcfop1[]"></td>
                                        <td><input class="form-control" type="text"   name="drowcfop1[]"></td>
                                        <td><input class="form-control" type="text"   name="drowcfop1[]"></td>
...
<script type="text/javascript">
    ...
    $("#wdladd").click(function () { //button name
        ++i;
        $("#wdl").append(
            '<tr><td class="counterCell " style="text-align: right" ></td><td><input class="form-control" type="number" name="dischargeLocation[]"></td><td><input class="form-control" type="text"  id="lo" name="dischargeLocation[]"></td><td><input class="form-control" type="text"  id="nrwb" name="dischargeLocation[]"></td></tr>'
                ); //table name
    });
</script>
