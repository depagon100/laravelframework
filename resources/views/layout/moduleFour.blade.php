                            ...
                            <table class="w3-table w3-striped w3-border" id ="summaryy1">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" name="summary1[]"></td>
                                        <td><input type="text" class="form-control" name="summary1[]"></td>
                                        <td><button type="button" name="add" id="sum1" class="btn btn-outline-primary" style="float:right">+</button></td>
                                    </tr>   
                                </tbody>
                            </table>
                            ...
                            <table class="w3-table w3-striped w3-border" id ="summaryy2">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><input type="text" class="form-control" name="summary2[]"></td>
                                        <td><button type="button" name="add" id="sum2" class="btn btn-outline-primary" style="float:right">+</button></td>
                                    </tr>
                            ...
                            <table class="w3-table w3-striped w3-border" id ="summaryy3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" name="summary3[]"></td>
                                        <td><input type="text" class="form-control" name="summary3[]"></td>
                                        <td><button type="button" name="add" id="sum3" class="btn btn-outline-primary" style="float:right">+</button></td>
                                    </tr>   
                                </tbody>
...
<script type="text/javascript">
    ...
    $("#sum1").click(function () { //button name
        ++i;
        $("#summaryy1").append
            ('<tr><td><input type="text" class="form-control" name="summary1[]"></td><td><input type="text" class="form-control" name="summary1[]"></td><td><input type="text" class="form-control" name="summary1[]"></td><td></td></tr>'); //table name
    });
</script>
...
<script type="text/javascript">
    ...
    $("#sum3").click(function () { //button name
        ++i;
        $("#summaryy3").append
            ('<tr><td><input type="text" class="form-control" name="summary3[]"></td><td><input type="text" class="form-control" name="summary3[]"></td><td><input type="text" class="form-control" name="summary3[]"></td><td></td> </tr>'); //table name
    });
</script>
